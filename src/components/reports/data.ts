...
export type Bucket = "today" | "yesterday" | "last7" | "last14" | "last30" | "mtd" | "lifetime";
...
export const BUCKET_FACTOR: Record<Bucket, number> = { today: 0.42, yesterday: 1, last7: 6.6, last14: 13, last30: 27.5, mtd: 14, lifetime: 120 };
